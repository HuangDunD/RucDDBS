...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_session_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Expression;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::session::FilterPlan, expression_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 36, -1, sizeof(::session::ChildPlan)},
  { 52, -1, sizeof(::session::ValuePlan)},
  { 58, -1, sizeof(::session::SeqScanPlan)},
  { 67, -1, sizeof(::session::TableGetPlan)},
  { 77, -1, sizeof(::session::FilterPlan)},
  { 84, -1, sizeof(::session::InsertPlan)},
  { 93, -1, sizeof(::session::DeletePlan)},
  { 102, -1, sizeof(::session::UpdatePlan)},
  { 111, -1, sizeof(::session::ProjectionPlan)},
  { 119, -1, sizeof(::session::NestedLoopJoin)},
  { 126, -1, sizeof(::session::DistributedPlan_Node)},
  { 133, -1, sizeof(::session::DistributedPlan)},
  { 140, -1, sizeof(::session::RemotePlan)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "r_expression\030\001 \001(\t\"\362\003\n\tChildPlan\022-\n\rseq_"
      "scan_plan\030\001 \001(\0132\024.session.SeqScanPlanH\000\022"
      "*\n\013filter_plan\030\002 \001(\0132\023.session.FilterPla"
      "nH\000\022/\n\014project_plan\030\003 \001(\0132\027.session.Proj"
      "ectionPlanH\000\022*\n\013insert_plan\030\004 \001(\0132\023.sess"
      "ion.InsertPlanH\000\022*\n\013delete_plan\030\005 \001(\0132\023."
      "session.DeletePlanH\000\022*\n\013update_plan\030\006 \001("
      "\0132\023.session.UpdatePlanH\000\0227\n\024nestedloop_j"
      "oin_plan\030\007 \001(\0132\027.session.NestedLoopJoinH"
      "\000\022(\n\nvalue_plan\030\010 \001(\0132\022.session.ValuePla"
      "nH\000\022.\n\rtable_get_pan\030\t \001(\0132\025.session.Tab"
      "leGetPlanH\000\0224\n\020distributed_plan\030\n \001(\0132\030."
      "session.DistributedPlanH\000B\014\n\nchild_plan\""
      "\032\n\tValuePlan\022\r\n\005value\030\002 \003(\t\"c\n\013SeqScanPl"
      "an\022\017\n\007db_name\030\001 \001(\t\022\020\n\010tab_name\030\002 \001(\t\022\016\n"
      "\006par_id\030\003 \001(\021\022!\n\005child\030\004 \003(\0132\022.session.C"
      "hildPlan\"q\n\014TableGetPlan\022\017\n\007db_name\030\001 \001("
      "\t\022\020\n\010tab_name\030\002 \001(\t\022\016\n\006par_id\030\003 \001(\021\022\013\n\003k"
      "ey\030\004 \001(\t\022!\n\005child\030\005 \003(\0132\022.session.ChildP"
      "lan\"X\n\nFilterPlan\022\'\n\nexpression\030\001 \003(\0132\023."
      "session.Expression\022!\n\005child\030\002 \003(\0132\022.sess"
      "ion.ChildPlan\"b\n\nInsertPlan\022\017\n\007db_name\030\001"
      " \001(\t\022\020\n\010tab_name\030\002 \001(\t\022\016\n\006par_id\030\003 \001(\021\022!"
      "\n\005child\030\004 \003(\0132\022.session.ChildPlan\"b\n\nDel"
      "etePlan\022\017\n\007db_name\030\001 \001(\t\022\020\n\010tab_name\030\002 \001"
      "(\t\022\016\n\006par_id\030\003 \001(\021\022!\n\005child\030\004 \003(\0132\022.sess"
      "ion.ChildPlan\"b\n\nUpdatePlan\022\017\n\007db_name\030\001"
      " \001(\t\022\020\n\010tab_name\030\002 \001(\t\022\016\n\006par_id\030\003 \001(\021\022!"
      "\n\005child\030\004 \003(\0132\022.session.ChildPlan\"W\n\016Pro"
      "jectionPlan\022\020\n\010tab_name\030\001 \001(\t\022\020\n\010col_nam"
      "e\030\002 \003(\t\022!\n\005child\030\003 \003(\0132\022.session.ChildPl"
      "an\"X\n\016NestedLoopJoin\022#\n\010jointype\030\001 \001(\0162\021"
      ".session.JoinType\022!\n\005child\030\002 \003(\0132\022.sessi"
      "on.ChildPlan\"\211\001\n\017DistributedPlan\022,\n\005node"
      "s\030\001 \003(\0132\035.session.DistributedPlan.Node\022!"
      "\n\005plans\030\002 \003(\0132\022.session.ChildPlan\032%\n\004Nod"
      "e\022\017\n\007ip_addr\030\001 \001(\t\022\014\n\004port\030\002 \001(\021\"/\n\nRemo"
      "tePlan\022!\n\005child\030\001 \001(\0132\022.session.ChildPla"
      "n*B\n\010JoinType\022\013\n\007INVALID\020\000\022\010\n\004LEFT\020\001\022\t\n\005"
      "RIGHT\020\003\022\t\n\005INNER\020\004\022\t\n\005OUTER\020\0052\205\001\n\017Sessio"
      "n_Service\022;\n\014SQL_Transfer\022\024.session.SQL_"
      "Request\032\025.session.SQL_Response\0225\n\016SendRe"
      "motePlan\022\023.session.RemotePlan\032\016.session."
      "TableB\003\200\001\001b\006proto3"
  };
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int FilterPlan::kExpressionFieldNumber;
...
void FilterPlan::SerializeWithCachedSizes(
  ...
  // repeated .session.Expression expression = 1;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->expression_size()); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1,
      this->expression(static_cast<int>(i)),
      output);
  }
...
::google::protobuf::uint8* FilterPlan::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->expression(static_cast<int>(i)), deterministic, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:session.FilterPlan)
  ...
  // repeated .session.Expression expression = 1;
  {
    unsigned int count = static_cast<unsigned int>(this->expression_size());
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::google::protobuf::internal::WireFormatLite::MessageSize(
...
void FilterPlan::InternalSwap(FilterPlan* other) {
  using std::swap;
  CastToBase(&expression_)->InternalSwap(CastToBase(&other->expression_));
  CastToBase(&child_)->InternalSwap(CastToBase(&other->child_));
  _internal_metadata_.Swap(&other->_internal_metadata_);
}
