...
TEST_F(LogManagerTest, AppendLogRecordTest) {
    ...
    // 测试用例 2
    LogRecord *record2 = new LogRecord(1, 0, LogRecordType::DELETE, 4, "key2", 6, "value2");
    ...
    // 测试用例 3
    LogRecord *record3 = new LogRecord(1, 0, LogRecordType::UPDATE, 4, "key3", 6, "value3", 10, "old_value3");
