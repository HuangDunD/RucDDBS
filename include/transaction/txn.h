...
class WriteRecord {
   public:
    WriteRecord() = default;
    // for insert record
    WriteRecord(const char* new_key, int32_t key_size, WType type){
    ...
    WriteRecord(const char* delete_key, int32_t key_size, const char* delete_value, int32_t value_size, WType type){
