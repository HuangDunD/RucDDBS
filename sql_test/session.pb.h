...
extern ColDefaultTypeInternal _Col_default_instance_;
class DeletePlan;
...
namespace google {
namespace protobuf {
template<> ::session::BinaryMessage* Arena::CreateMaybeMessage<::session::BinaryMessage>(Arena*);
template<> ::session::ChildPlan* Arena::CreateMaybeMessage<::session::ChildPlan>(Arena*);
template<> ::session::Col* Arena::CreateMaybeMessage<::session::Col>(Arena*);
...
template<> ::session::Expr* Arena::CreateMaybeMessage<::session::Expr>(Arena*);
...
class Expr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:session.Expr) */ {
 public:
  Expr();
  virtual ~Expr();
  ...
  private:
  const ::session::Value& _internal_val() const;
  public:
  const ::session::Value& val() const;
  ::session::Value* release_val();
  ::session::Value* mutable_val();
  void set_allocated_val(::session::Value* val);
  ...
  private:
  const ::session::Col& _internal_col() const;
  public:
  const ::session::Col& col() const;
  ::session::Col* release_col();
  ::session::Col* mutable_col();
  void set_allocated_col(::session::Col* col);

  void clear_exp();
  ExpCase exp_case() const;
  // @@protoc_insertion_point(class_scope:session.Expr)
 private:
  void set_has_val();
  void set_has_col();
...
class BinaryMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:session.BinaryMessage) */ {
 public:
  BinaryMessage();
  virtual ~BinaryMessage();

  BinaryMessage(const BinaryMessage& from);
  ...
  #if LANG_CXX11
  BinaryMessage(BinaryMessage&& from) noexcept
    : BinaryMessage() {
    *this = ::std::move(from);
  }
  ...
  void Swap(BinaryMessage* other);
  friend void swap(BinaryMessage& a, BinaryMessage& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline BinaryMessage* New() const final {
    return CreateMaybeMessage<BinaryMessage>(NULL);
  }

  BinaryMessage* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<BinaryMessage>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const BinaryMessage& from);
  void MergeFrom(const BinaryMessage& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  private:
  const ::session::Expr& _internal_exp() const;
  public:
  const ::session::Expr& exp() const;
  ::session::Expr* release_exp();
  ::session::Expr* mutable_exp();
  void set_allocated_exp(::session::Expr* exp);
  ...
  // @@protoc_insertion_point(class_scope:session.BinaryMessage)
 private:
...
class FilterPlan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:session.FilterPlan) */ {
 public:
  ...
  bool has_conds() const;
  void clear_conds();
  static const int kCondsFieldNumber = 1;
  private:
  const ::session::BinaryMessage& _internal_conds() const;
  public:
  const ::session::BinaryMessage& conds() const;
  ::session::BinaryMessage* release_conds();
  ::session::BinaryMessage* mutable_conds();
  void set_allocated_conds(::session::BinaryMessage* conds);
...
class UpdatePlan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:session.UpdatePlan) */ {
 public:
  ...
  int set_col_index_size() const;
  void clear_set_col_index();
  static const int kSetColIndexFieldNumber = 4;
  ::google::protobuf::int32 set_col_index(int index) const;
  void set_set_col_index(int index, ::google::protobuf::int32 value);
  void add_set_col_index(::google::protobuf::int32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      set_col_index() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_set_col_index();

  // repeated sint32 set_val = 5;
  int set_val_size() const;
  void clear_set_val();
  static const int kSetValFieldNumber = 5;
  ::google::protobuf::int32 set_val(int index) const;
  void set_set_val(int index, ::google::protobuf::int32 value);
  void add_set_val(::google::protobuf::int32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      set_val() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_set_val();
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > set_col_index_;
  mutable int _set_col_index_cached_byte_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > set_val_;
  mutable int _set_val_cached_byte_size_;
  ::google::protobuf::RepeatedPtrField< ::session::ChildPlan > child_;
  ::google::protobuf::internal::ArenaStringPtr db_name_;
  ::google::protobuf::internal::ArenaStringPtr tab_name_;
  ::google::protobuf::int32 par_id_;
...
// string tab_name = 1;
inline void Col::clear_tab_name() {
  tab_name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& Col::tab_name() const {
  // @@protoc_insertion_point(field_get:session.Col.tab_name)
  return tab_name_.GetNoArena();
}
inline void Col::set_tab_name(const ::std::string& value) {
  
  tab_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:session.Col.tab_name)
}
#if LANG_CXX11
inline void Col::set_tab_name(::std::string&& value) {
  
  tab_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:session.Col.tab_name)
}
#endif
inline void Col::set_tab_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  tab_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:session.Col.tab_name)
}
inline void Col::set_tab_name(const char* value, size_t size) {
  
  tab_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:session.Col.tab_name)
}
inline ::std::string* Col::mutable_tab_name() {
  
  // @@protoc_insertion_point(field_mutable:session.Col.tab_name)
  return tab_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Col::release_tab_name() {
  // @@protoc_insertion_point(field_release:session.Col.tab_name)
  
  return tab_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Col::set_allocated_tab_name(::std::string* tab_name) {
  if (tab_name != NULL) {
  ...
  tab_name_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), tab_name);
  // @@protoc_insertion_point(field_set_allocated:session.Col.tab_name)
}

// string col_name = 2;
inline void Col::clear_col_name() {
  col_name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& Col::col_name() const {
  // @@protoc_insertion_point(field_get:session.Col.col_name)
  return col_name_.GetNoArena();
}
inline void Col::set_col_name(const ::std::string& value) {
  
  col_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:session.Col.col_name)
}
#if LANG_CXX11
inline void Col::set_col_name(::std::string&& value) {
  
  col_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:session.Col.col_name)
}
#endif
inline void Col::set_col_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  col_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:session.Col.col_name)
}
inline void Col::set_col_name(const char* value, size_t size) {
  
  col_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:session.Col.col_name)
}
inline ::std::string* Col::mutable_col_name() {
  
  // @@protoc_insertion_point(field_mutable:session.Col.col_name)
  return col_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Col::release_col_name() {
  // @@protoc_insertion_point(field_release:session.Col.col_name)
  
  return col_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Col::set_allocated_col_name(::std::string* col_name) {
  if (col_name != NULL) {
...
inline const ::session::Value& Expr::_internal_val() const {
  return *exp_.val_;
}
inline ::session::Value* Expr::release_val() {
  // @@protoc_insertion_point(field_release:session.Expr.val)
  if (has_val()) {
    clear_has_exp();
      ::session::Value* temp = exp_.val_;
    exp_.val_ = NULL;
    return temp;
  } else {
    return NULL;
...
inline const ::session::Value& Expr::val() const {
  // @@protoc_insertion_point(field_get:session.Expr.val)
  return has_val()
      ? *exp_.val_
      : *reinterpret_cast< ::session::Value*>(&::session::_Value_default_instance_);
}
inline ::session::Value* Expr::mutable_val() {
  if (!has_val()) {
    clear_exp();
    set_has_val();
    exp_.val_ = CreateMaybeMessage< ::session::Value >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:session.Expr.val)
  return exp_.val_;
}

// .session.Col col = 2;
inline bool Expr::has_col() const {
  return exp_case() == kCol;
}
inline void Expr::set_has_col() {
  _oneof_case_[0] = kCol;
}
inline void Expr::clear_col() {
  if (has_col()) {
    delete exp_.col_;
    clear_has_exp();
  }
}
inline const ::session::Col& Expr::_internal_col() const {
  return *exp_.col_;
}
inline ::session::Col* Expr::release_col() {
  // @@protoc_insertion_point(field_release:session.Expr.col)
  if (has_col()) {
    clear_has_exp();
      ::session::Col* temp = exp_.col_;
    exp_.col_ = NULL;
    return temp;
  } else {
    return NULL;
...
inline const ::session::Col& Expr::col() const {
  // @@protoc_insertion_point(field_get:session.Expr.col)
  return has_col()
      ? *exp_.col_
      : *reinterpret_cast< ::session::Col*>(&::session::_Col_default_instance_);
}
inline ::session::Col* Expr::mutable_col() {
  if (!has_col()) {
    clear_exp();
    set_has_col();
    exp_.col_ = CreateMaybeMessage< ::session::Col >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:session.Expr.col)
  return exp_.col_;
}

inline bool Expr::has_exp() const {
  return exp_case() != EXP_NOT_SET;
}
inline void Expr::clear_has_exp() {
  _oneof_case_[0] = EXP_NOT_SET;
}
inline Expr::ExpCase Expr::exp_case() const {
  return Expr::ExpCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// .session.Col col = 1;
inline bool BinaryMessage::has_col() const {
  return this != internal_default_instance() && col_ != NULL;
}
inline void BinaryMessage::clear_col() {
  if (GetArenaNoVirtual() == NULL && col_ != NULL) {
    delete col_;
  }
  col_ = NULL;
}
inline const ::session::Col& BinaryMessage::_internal_col() const {
  return *col_;
}
inline const ::session::Col& BinaryMessage::col() const {
  const ::session::Col* p = col_;
  // @@protoc_insertion_point(field_get:session.BinaryMessage.col)
  return p != NULL ? *p : *reinterpret_cast<const ::session::Col*>(
      &::session::_Col_default_instance_);
}
inline ::session::Col* BinaryMessage::release_col() {
  // @@protoc_insertion_point(field_release:session.BinaryMessage.col)
  
  ::session::Col* temp = col_;
  col_ = NULL;
  return temp;
}
inline ::session::Col* BinaryMessage::mutable_col() {
  
  if (col_ == NULL) {
    auto* p = CreateMaybeMessage<::session::Col>(GetArenaNoVirtual());
    col_ = p;
  }
  // @@protoc_insertion_point(field_mutable:session.BinaryMessage.col)
  return col_;
}
inline void BinaryMessage::set_allocated_col(::session::Col* col) {
  ...
  col_ = col;
  // @@protoc_insertion_point(field_set_allocated:session.BinaryMessage.col)
}

// sint32 op = 2;
inline void BinaryMessage::clear_op() {
  op_ = 0;
}
inline ::google::protobuf::int32 BinaryMessage::op() const {
  // @@protoc_insertion_point(field_get:session.BinaryMessage.op)
  return op_;
}
inline void BinaryMessage::set_op(::google::protobuf::int32 value) {
  
  op_ = value;
  // @@protoc_insertion_point(field_set:session.BinaryMessage.op)
}

// .session.Expr exp = 3;
inline bool BinaryMessage::has_exp() const {
  return this != internal_default_instance() && exp_ != NULL;
}
inline void BinaryMessage::clear_exp() {
  if (GetArenaNoVirtual() == NULL && exp_ != NULL) {
    delete exp_;
  }
  exp_ = NULL;
}
inline const ::session::Expr& BinaryMessage::_internal_exp() const {
  return *exp_;
}
inline const ::session::Expr& BinaryMessage::exp() const {
  const ::session::Expr* p = exp_;
  // @@protoc_insertion_point(field_get:session.BinaryMessage.exp)
  return p != NULL ? *p : *reinterpret_cast<const ::session::Expr*>(
      &::session::_Expr_default_instance_);
}
inline ::session::Expr* BinaryMessage::release_exp() {
  // @@protoc_insertion_point(field_release:session.BinaryMessage.exp)
  
  ::session::Expr* temp = exp_;
  exp_ = NULL;
  return temp;
}
inline ::session::Expr* BinaryMessage::mutable_exp() {
  
  if (exp_ == NULL) {
    auto* p = CreateMaybeMessage<::session::Expr>(GetArenaNoVirtual());
    exp_ = p;
  }
  // @@protoc_insertion_point(field_mutable:session.BinaryMessage.exp)
  return exp_;
}
inline void BinaryMessage::set_allocated_exp(::session::Expr* exp) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete exp_;
  }
  if (exp) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      exp = ::google::protobuf::internal::GetOwnedMessage(
  ...
  exp_ = exp;
  // @@protoc_insertion_point(field_set_allocated:session.BinaryMessage.exp)
}
...
// .session.BinaryMessage conds = 1;
inline bool FilterPlan::has_conds() const {
  return this != internal_default_instance() && conds_ != NULL;
}
inline void FilterPlan::clear_conds() {
  if (GetArenaNoVirtual() == NULL && conds_ != NULL) {
    delete conds_;
  }
  conds_ = NULL;
}
inline const ::session::BinaryMessage& FilterPlan::_internal_conds() const {
  return *conds_;
}
inline const ::session::BinaryMessage& FilterPlan::conds() const {
  const ::session::BinaryMessage* p = conds_;
  // @@protoc_insertion_point(field_get:session.FilterPlan.conds)
  return p != NULL ? *p : *reinterpret_cast<const ::session::BinaryMessage*>(
      &::session::_BinaryMessage_default_instance_);
}
inline ::session::BinaryMessage* FilterPlan::release_conds() {
  // @@protoc_insertion_point(field_release:session.FilterPlan.conds)
  
  ::session::BinaryMessage* temp = conds_;
  conds_ = NULL;
  return temp;
}
inline ::session::BinaryMessage* FilterPlan::mutable_conds() {
  
  if (conds_ == NULL) {
    auto* p = CreateMaybeMessage<::session::BinaryMessage>(GetArenaNoVirtual());
    conds_ = p;
  }
  // @@protoc_insertion_point(field_mutable:session.FilterPlan.conds)
  return conds_;
}
inline void FilterPlan::set_allocated_conds(::session::BinaryMessage* conds) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete conds_;
  }
  if (conds) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      conds = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, conds, submessage_arena);
    }
  ...
  conds_ = conds;
  // @@protoc_insertion_point(field_set_allocated:session.FilterPlan.conds)
}
...
// repeated string col_name = 4;
inline int InsertPlan::col_name_size() const {
  return col_name_.size();
}
inline void InsertPlan::clear_col_name() {
  col_name_.Clear();
}
inline const ::std::string& InsertPlan::col_name(int index) const {
  // @@protoc_insertion_point(field_get:session.InsertPlan.col_name)
  return col_name_.Get(index);
}
inline ::std::string* InsertPlan::mutable_col_name(int index) {
  // @@protoc_insertion_point(field_mutable:session.InsertPlan.col_name)
  return col_name_.Mutable(index);
}
inline void InsertPlan::set_col_name(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:session.InsertPlan.col_name)
  col_name_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void InsertPlan::set_col_name(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:session.InsertPlan.col_name)
  col_name_.Mutable(index)->assign(std::move(value));
}
#endif
inline void InsertPlan::set_col_name(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  col_name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:session.InsertPlan.col_name)
}
inline void InsertPlan::set_col_name(int index, const char* value, size_t size) {
  col_name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:session.InsertPlan.col_name)
}
inline ::std::string* InsertPlan::add_col_name() {
  // @@protoc_insertion_point(field_add_mutable:session.InsertPlan.col_name)
  return col_name_.Add();
}
inline void InsertPlan::add_col_name(const ::std::string& value) {
  col_name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:session.InsertPlan.col_name)
}
#if LANG_CXX11
inline void InsertPlan::add_col_name(::std::string&& value) {
  col_name_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:session.InsertPlan.col_name)
}
#endif
inline void InsertPlan::add_col_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  col_name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:session.InsertPlan.col_name)
}
inline void InsertPlan::add_col_name(const char* value, size_t size) {
  col_name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:session.InsertPlan.col_name)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
InsertPlan::col_name() const {
  // @@protoc_insertion_point(field_list:session.InsertPlan.col_name)
  return col_name_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
InsertPlan::mutable_col_name() {
  // @@protoc_insertion_point(field_mutable_list:session.InsertPlan.col_name)
  return &col_name_;
}

// repeated sint32 val = 5;
inline int InsertPlan::val_size() const {
  return val_.size();
}
inline void InsertPlan::clear_val() {
  val_.Clear();
}
inline ::google::protobuf::int32 InsertPlan::val(int index) const {
  // @@protoc_insertion_point(field_get:session.InsertPlan.val)
  return val_.Get(index);
}
inline void InsertPlan::set_val(int index, ::google::protobuf::int32 value) {
  val_.Set(index, value);
  // @@protoc_insertion_point(field_set:session.InsertPlan.val)
}
inline void InsertPlan::add_val(::google::protobuf::int32 value) {
  val_.Add(value);
  // @@protoc_insertion_point(field_add:session.InsertPlan.val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
InsertPlan::val() const {
  // @@protoc_insertion_point(field_list:session.InsertPlan.val)
  return val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
InsertPlan::mutable_val() {
  // @@protoc_insertion_point(field_mutable_list:session.InsertPlan.val)
  return &val_;
}
...
// repeated sint32 set_col_index = 4;
inline int UpdatePlan::set_col_index_size() const {
  return set_col_index_.size();
}
inline void UpdatePlan::clear_set_col_index() {
  set_col_index_.Clear();
}
inline ::google::protobuf::int32 UpdatePlan::set_col_index(int index) const {
  // @@protoc_insertion_point(field_get:session.UpdatePlan.set_col_index)
  return set_col_index_.Get(index);
}
inline void UpdatePlan::set_set_col_index(int index, ::google::protobuf::int32 value) {
  set_col_index_.Set(index, value);
  // @@protoc_insertion_point(field_set:session.UpdatePlan.set_col_index)
}
inline void UpdatePlan::add_set_col_index(::google::protobuf::int32 value) {
  set_col_index_.Add(value);
  // @@protoc_insertion_point(field_add:session.UpdatePlan.set_col_index)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
UpdatePlan::set_col_index() const {
  // @@protoc_insertion_point(field_list:session.UpdatePlan.set_col_index)
  return set_col_index_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
UpdatePlan::mutable_set_col_index() {
  // @@protoc_insertion_point(field_mutable_list:session.UpdatePlan.set_col_index)
  return &set_col_index_;
}

// repeated sint32 set_val = 5;
inline int UpdatePlan::set_val_size() const {
  return set_val_.size();
}
inline void UpdatePlan::clear_set_val() {
  set_val_.Clear();
}
inline ::google::protobuf::int32 UpdatePlan::set_val(int index) const {
  // @@protoc_insertion_point(field_get:session.UpdatePlan.set_val)
  return set_val_.Get(index);
}
inline void UpdatePlan::set_set_val(int index, ::google::protobuf::int32 value) {
  set_val_.Set(index, value);
  // @@protoc_insertion_point(field_set:session.UpdatePlan.set_val)
}
inline void UpdatePlan::add_set_val(::google::protobuf::int32 value) {
  set_val_.Add(value);
  // @@protoc_insertion_point(field_add:session.UpdatePlan.set_val)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
UpdatePlan::set_val() const {
  // @@protoc_insertion_point(field_list:session.UpdatePlan.set_val)
  return set_val_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
UpdatePlan::mutable_set_val() {
  // @@protoc_insertion_point(field_mutable_list:session.UpdatePlan.set_val)
  return &set_val_;
}
